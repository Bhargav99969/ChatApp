...
const ProfilePage = () => {
  ...
  const updatedProfile=useAuthStore((state)=>state.updateProfile)
  ...
  return (
    <div className="h-[100vh] pt-20  bg-base-100 backdrop-blur-lg bg-base-100/80 bg-gray-900">
        ...
        <div className="bg-base-300 rounded-xl p-2 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                src={selectedImg || authUser.profilePic || "../src/assets/react.svg"}
                alt="Profile"
